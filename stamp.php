<?php
	...
	{
		echo"<script>alert('Stamp has been successfully added to your cart');</script>";
		$addid=$_POST['addcart'];
		$user=$_SESSION['email'];
...
<body>
	...
	<div class="splitl left">
		...
		<div class="splitr right">
				<br/><center><h1><b>Hey! You can add these Stamps to your collection</b></h1></center><br/>
				<?php 

				   $e=$_SESSION['email'];
				   $q="select * from exchangeables where pid!='$e' and category='stamp'";
